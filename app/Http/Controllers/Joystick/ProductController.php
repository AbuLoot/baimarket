...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $product_lang->slug = Str::slug($request->title);
    ...
    public function saveImages($request, $dirName)
    {
        ...
        foreach ($request->file('images') as $key => $image)
        {
            ...
            $this->resizeOptimalImage($image, 320, 300, '/img/products/'.$dirName.'/present-'.$imageName, 90);

            // Storing original images
            // $image->storeAs('/img/products/'.$dirName, $imageName);
            $this->resizeOptimalImage($image, 800, 750, '/img/products/'.$dirName.'/'.$imageName, 90);
